 ...
 */
function ISODate(source, offset = -1, endChars = '', enforceSeparators = false) {
  this.source = source;
  /** @type {number} */
  // @ts-ignore
 ...
 * @param {number} [offset]
 */
function ISODuration(source, offset = 0) {
  this.source = source;
  this.idx = offset;
  this.c = '';
  this.type = '';
 ...
 * @returns {ISOInterval}
 */
function parseInterval(isoInterval) {
 ...
 */
function getDate(isoDateSource) {
 ...
 */
function getExpireAt(isoInterval, compareDate, startDate) {
 ...
 */
function getStartAt(isoInterval, compareDate, endDate) {
...
exports.ISOInterval = ISOInterval;
exports.getDate = getDate;
exports.getExpireAt = getExpireAt;
exports.getStartAt = getStartAt;
